...
public class Sala {
    ...
    protected Sala(String nome, String descricao, Data dataCriacao, Usuario lider) {
        this.id = proxId++;
        this.nome = nome;
    ...
    public static Sala getInstance(String nome, String descricao, Data dataCriacao, Usuario lider) {
